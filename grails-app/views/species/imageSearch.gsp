    ...
    <head>
        <title>
            <g:if test="${taxonConcept}">
                ${taxonConcept.taxonConcept.taxonRank}  ${taxonConcept.taxonConcept.nameString} |
            </g:if>
            Image browser | ${grailsApplication.config.skin.orgNameLong}
        </title>
        ...
        <header id="page-header" class="heading-bar">
            <div class="inner row">
                <nav id="breadcrumb" class="span12">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <g:link controller="species" action="search">
                                species
                            </g:link>
                            <span class=" icon icon-arrow-right"></span>
                        </li>
            ...
            <h1>
                ...
                <g:if test="${taxonConcept}">
                    ...
                    <a href="${grailsApplication.config.grails.serverURL}/species/${taxonConcept?.taxonConcept?.guid}" title="More information on this ${taxonConcept?.taxonConcept?.taxonRank}">
